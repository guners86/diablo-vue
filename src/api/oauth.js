...
const clientId = process.env.VUE_APP_CLIENT_ID // Variables de entorno privadas
const clientSecret = process.env.VUE_APP_CLIENT_SECRET // Variables de entorno privadas
