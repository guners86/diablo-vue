...
export default {
  ...
  actions: {
    ...
    getToken ({ commit }) {
      // Seteamos el valor de isLoading en true para el modulo de loading en vuex
      ...
      oauth.getToken().then(({ data }) => {
        ...
        // Seteamos el valor de isLoading en false para el modulo de loading en vuex
